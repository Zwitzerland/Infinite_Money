...
class PlatformSettings(BaseSettings):
    ...
    fred_api_key: SecretStr | None = Field(
        default=None,
        description="FRED API key (inject via secrets manager).",
    )
    ...
    currents_api_key: SecretStr | None = Field(
        default=None,
        description="Currents API key (optional).",
    )
    eventregistry_api_key: SecretStr | None = Field(
        default=None,
        description="Event Registry API key (optional).",
    )
