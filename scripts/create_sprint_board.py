...
"""
    ...
    def save_outputs(self, board: Dict[str, Any], output_dir: str = "sprint_output"):
        ...
        print("   - sprint_board.json: Complete sprint data")
        print("   - sprint_board.md: Markdown documentation")
        print("   - github_issues.json: GitHub issue templates")
...
def main():
    ...
    try:
        ...
        print("3. Assign owners and start Day-1 tasks")
